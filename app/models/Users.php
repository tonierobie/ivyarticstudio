...
use Core\Validators\OptionalValidator;
...
class Users extends Model {
  ...
  public $id,$username,$email,$password,$fname,$lname,$acl,$artistic_name,$description,$approval = 0,$deleted = 0,$confirm;
  ...
  public function validator(){
    ...
    $this->runValidation(new UniqueValidator($this,['field'=>['email','deleted'],'msg'=>'That email already exists.']));
    ...
    if($this->acl == '["Artist"]'){
      $this->runValidation(new RequiredValidator($this,['field'=>'description','msg'=>'Artist description is required.']));
      $this->runValidation(new RequiredValidator($this,['field'=>'artistic_name','msg'=>'artistic Name is required.']));
    }
  }
  ...
  public static function findByUsername($username) {
    return self::findFirst(['conditions'=> "username = ? AND approval = ?", 'bind'=>[$username,1]]);
  }
  ...
  public static function findByUserId($user_id) {
    return self::findFirst(['conditions'=> "id = ?", 'bind'=>[$user_id]]);
  }
