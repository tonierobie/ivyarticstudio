  ...
  <div class="col-md-6 bg-light p-3">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="row">
        ...
        <?= FH::inputBlock('text','Acl','acl',$acl3,['class'=>'form-control input-sm'],['class'=>'form-group col-md-3'],$this->displayErrors, 'readonly')?>
      </div>
      <div class="row">
      ...
      <div class="row">
        <div class="col-md-12 text-right">
          <a href="<?=PROOT?>" class="btn btn-large btn-secondary">Cancel</a>
